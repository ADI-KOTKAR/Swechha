package com.example.template.Rv_Swipe_CB.Helper
    ...
    :ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT)
{
    ...
    private val gestuerListener = object:GestureDetector.SimpleOnGestureListener(){
    ...
    private val onTouchListener = View.OnTouchListener{_,motionEvent->
        ...
        val swipedItem = swipeHolder!!.itemView
        val rect = Rect()
    ...
    init{
        ...
        this.gestureDetector = GestureDetector(context,gestuerListener)
